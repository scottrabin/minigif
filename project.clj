    ...
    :builds {:background
             {:source-paths ["src/minigif/background" "src/minigif/common" "checkouts/chromate/src"]
              :compiler {:output-to "dist/js/minigif-background.js"
                         ...
                         :source-map true}}
             :manage
             {:source-paths ["src/minigif/manage" "src/minigif/common" "src/minigif/component"]
              :compiler {:output-to "dist/js/minigif-manage.js"
                         :output-dir "dist/js/out/minigif-manage"
                         :optimizations :none
                         :source-map true}}
             :search
             {:source-paths ["src/minigif/search" "src/minigif/common" "src/minigif/component"]
              :compiler {:output-to "dist/js/minigif-search.js"
                         :output-dir "dist/js/out/minigif-search"
                         :optimizations :none
                         :source-map true}}
             :newimage
             {:source-paths ["src/minigif/newimage" "src/minigif/common" "src/minigif/component"]
